				...
				<div class="col-md-10">
					...
					<div class="col-md-3" style="text-align:center;padding:2px;">
						...
						<c:forEach items="${spu.skus}" var="sku">
							<a href="javascript:void(0)" onmouseover="changePic(${spu.id},${sku.id},'pic/${sku.image }',${sku.price})"><img src="pic/${sku.image}" style="width:40px;height:40px"></a>
						</c:forEach>
						</div>
						<p><font color="#E4393C" style="font-size:16px" id="price${spu.id}">${spu.skus[0].price}</font></p>
